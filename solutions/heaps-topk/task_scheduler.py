...
number n. Each CPU interval can be idle or allow the completion of one task. Tasks
can be completed in any order, but there's a constraint: there has to be a gap of at
...
Example 1:
    ...
    applies to task B. In the 3^rd interval, neither A nor B can be done, so you idle.
...
if __name__ == "__main__":
    ...
    run(Solution().leastInterval, CASES)
